...
const TodoDrawer = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 h-full w-full bg-white shadow-lg p-6 transition-transform duration-300 ease-in-out transform md:max-w-[80%] z-50 ${
      ...
      >
        ...
        {editTodo && <button onClick={onDelete}>삭제</button>}
      </div>
    </>
  );
};
